  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className={cn(
          "relative grow overflow-hidden rounded-full bg-zinc-300 data-[orientation=horizontal]:h-2 data-[orientation=vertical]:h-full data-[orientation=horizontal]:w-full data-[orientation=vertical]:w-2 dark:bg-zinc-600"
        )}
      >
